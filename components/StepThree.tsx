    ...
    <section className="bg-white py-32">
      <div className="max-w-[1300px] mx-auto px-8 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
        ...
        <div>
          ...
          {/* STEP PILL */}
          <span className="inline-block mb-6 px-4 py-1 rounded-full bg-blue-100 text-blue-600 text-sm font-medium">
            Step 3
          </span>

          {/* HEADING */}
          <h2 className="text-[42px] leading-[52px] font-bold text-gray-900 mb-6">
            Let your customers share what <br />
            they love about you
          </h2>
        ...
        <div className="relative">
          ...
          {/* GRADIENT CONTAINER */}
          <div className="relative rounded-[28px] p-10 bg-gradient-to-br from-cyan-400 via-teal-300 to-green-200">
